...
|------------+-------------------------------------------+-------------------------------------------------------------------------------------------------------------|
| 03-29-2018 | [[./notebooks/numpy_basics.ipynb][numpy notebook]]                            | Covered creation, indexing, slicing, linear algebra and array oriented programming for n-dimensional array. |
|            |                                           | Also remember *any and all* method for boolean arrays.                                                      |
|------------+-------------------------------------------+-------------------------------------------------------------------------------------------------------------|
...
|            |                                           | Get install slide show extension follow [[https://github.com/damianavila/RISE][Rise Slideshow Extension]] link or                                    |
|            |                                           | do *conda install -c damianavila82 rise* for Anaconda installation                                          |
|------------+-------------------------------------------+-------------------------------------------------------------------------------------------------------------|
|            |                                           |                                                                                                             |
